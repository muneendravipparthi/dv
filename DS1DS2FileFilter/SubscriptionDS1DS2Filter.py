...
Ds2ColList = ["customer[id]", "subscription[id]", "subscription[created_at]", "subscription[plan_id]org", "subscription_items[quantity][0]", "subscription_items[unit_price][0]", "subscription[status]", "subscription[trial_start]", "subscription[trial_end]", "subscription[started_at]", "subscription[current_term_start]", "subscription[current_term_end]", "subscription[cancelled_at]", "subscription[auto_collection]", "coupon_ids[0]org", "subscription[meta_data]"]
